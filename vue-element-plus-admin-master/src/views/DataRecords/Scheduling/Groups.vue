      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            <el-button type="primary" @click="handleExport" v-hasPermi="'scheduling:groups:export'">
            ...
            <el-button
              ...
              @click="handleAdd"
              style="margin-left: 10px"
              v-hasPermi="'scheduling:groups:add'"
            >
        ...
        <el-table-column label="操作" width="150" align="center" fixed="right">
          <template #default="{ row }">
            <el-button
              ...
              v-hasPermi="'scheduling:groups:edit'"
            >
            ...
            <el-button
              ...
              v-hasPermi="'scheduling:groups:delete'"
            >
...
const hasImportPerm = hasPermi('scheduling:groups:import')
