      ...
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            <el-button type="primary" @click="handleExport" v-hasPermi="'scheduling:staff:export'">
            ...
            <el-button
              ...
              @click="handleAdd"
              style="margin-left: 10px"
              v-hasPermi="'scheduling:staff:add'"
            >
        ...
        <el-table-column label="操作" width="150" align="center" fixed="right">
          <template #default="{ row }">
            <el-button
              ...
              v-hasPermi="'scheduling:staff:edit'"
            >
            ...
            <el-button
              ...
              v-hasPermi="'scheduling:staff:delete'"
            >
...
const hasImportPerm = hasPermi('scheduling:staff:import')
