<template>
  <div class="scheduling">
    ...
    <el-dialog v-model="addScheduleDialogVisible" title="添加排班" width="500px">
    ...
    <el-dialog v-model="editScheduleDialogVisible" title="编辑排班" width="500px">
  ...
  try {
    ...
    if (res.code === 200) {
      ...
      if (selectedDay.value) {
        selectedDay.value.schedules = selectedDay.value.schedules.filter(
          (s) => s.id !== schedule.id
        )
      }
    } else {
