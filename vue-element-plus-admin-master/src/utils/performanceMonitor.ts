...
class PerformanceMonitor {
      ...
      const observer = new PerformanceObserver((list) => {
        ...
        entries.forEach(entry => {
          if (entry.entryType === 'navigation') {
            ...
            this.recordMetric('page_load_time', navEntry.loadEventEnd - navEntry.fetchStart, 'navigation')
            this.recordMetric('dom_content_loaded', navEntry.domContentLoadedEventEnd - navEntry.fetchStart, 'navigation')
            this.recordMetric('dom_complete', navEntry.domComplete - navEntry.fetchStart, 'navigation')
            this.recordMetric('first_byte', navEntry.responseStart - navEntry.fetchStart, 'navigation')
          }
        })
      })
  ...
  recordMetric(name: string, value: number, type: 'navigation' | 'resource' | 'paint' | 'custom' = 'custom') {
